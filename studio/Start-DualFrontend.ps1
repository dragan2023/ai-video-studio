...
# Expected repo layout (monorepo):
#   ai-video-studio/studio/Start-DualFrontend.ps1
#   ai-video-studio/canvas/web/package.json
$ErrorActionPreference = "Stop"
$NautilusRoot = $PSScriptRoot
$WorkspaceRoot = Split-Path -Parent $NautilusRoot
$CanvasWeb = Join-Path $WorkspaceRoot "canvas\web"
